export default {
  ...
  loraLibrary: {
    ...
    convertToGguf: 'Convert to GGUF (for llama.cpp)',
    convertStarted: 'Converting {name} to GGUF',
    convertStartedDesc: 'Runs in the background; the GGUF adapter appears here when done.',
    convertFailed: 'GGUF conversion failed',
  ...
  cost: {
    title: 'Cost',
    description: 'Spend per model and per API key, from token usage x your price table.',
    since: 'Since',
    until: 'Until',
    apply: 'Apply',
    locked: 'Unlock to view cost.',
    unlock: 'Unlock',
    totalSpend: 'Total spend',
    byModel: 'By model',
    byKey: 'By API key',
    priceUnit: 'Prices are per 1M tokens (input / output).',
    pricedHint: 'Cost is computed from each model’s configured price.',
    unpricedHint: 'Some models have no price set — they use the default (edit a row below to set one).',
    defaultPrice: 'Default: {cur} {in} in / {out} out per 1M tokens.',
    default: 'default',
    colModel: 'Model',
    colReq: 'Reqs',
    colIn: 'Input tok',
    ...
    priceSaved: 'Price saved for {model}',
    saveFailed: 'Failed to save price',
    badPrice: 'Prices must be ≥ 0',
    loadFailed: 'Failed to load cost',
    noData: 'No usage in this range.',
  },

  // ---- Config versions (export / import / rollback) ----
  config: {
    title: 'Config Versions',
    description: 'Back up, restore and roll back the dynamic-model overlay (every runtime change lives there; config.yaml is untouched).',
    export: 'Export',
    import: 'Import',
    denied: 'Only an operator or admin can view config versions.',
    locked: 'Unlock with a token to view config versions.',
    unlock: 'Unlock',
    ...
    loadMore: 'Load more',
    end: 'No more versions',
    none: 'No versions yet. Changes are snapshotted automatically.',
    diffTitle: 'Version {id} vs current',
    nAdded: '{n} added',
    nRemoved: '{n} removed',
    nChanged: '{n} changed',
    noChange: 'no instance changes',
    imported: 'Config imported',
    importFailed: 'Import failed',
    exportFailed: 'Export failed',
    badFile: 'Not a valid JSON config file',
    rolledBack: 'Rolled back to version {id}',
    rollbackFailed: 'Rollback failed',
    diffFailed: 'Failed to load diff',
    rollbackConfirm: 'Roll back the live config to version {id}? This replaces the current overlay (a new version is recorded, so you can roll forward).',
    runningConfirm: '{detail}\n\nStop them and apply anyway (force)?',
  },
  ...
  modelControl: {
    ...
    orToken: 'or use a token',
    tokenLabel: 'Token',
    tokenPlaceholder: 'Admin or operator token',
