export default {
  ...
  loraLibrary: {
    ...
    unknownBase: '未知 base',
    convertToGguf: '轉成 GGUF（給 llama.cpp 用）',
    convertStarted: '正在把 {name} 轉成 GGUF',
    convertStartedDesc: '背景執行；完成後 GGUF adapter 會出現在這裡。',
    convertFailed: 'GGUF 轉換失敗',
    converting: '轉換 GGUF 中…',
